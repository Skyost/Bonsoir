...
namespace bonsoir_windows {
    ...
    void BonsoirBroadcast::start() {
        ...
        if (error == kDNSServiceErr_NoError) {
            ...
            on_error("Bonsoir service failed to broadcast : " + service.get_description() + ", error code : " + std::to_string(error), EncodableValue(error));
            dispose();
        }
    }
    ...
    void registerCallback(
        ...
        if (errorCode == kDNSServiceErr_NoError) {
            ...
            broadcast->on_error("Bonsoir service failed to broadcast : " + service.get_description(), EncodableValue(errorCode));
            broadcast->dispose();
        }
    }
}