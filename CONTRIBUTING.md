...
Bonsoir is setup to run with the most recent `stable` version of Flutter, so make sure your version
matches that :
...
Also, Bonsoir uses [Melos] to manage the project and dependencies.
...
Go to the [pull request page of Bonsoir][PRs] and in the top
...
These instructions are for the maintainers of Bonsoir.
...
[GitHub issue]: https://github.com/Skyost/Bonsoir/issues
[GitHub issues]: https://github.com/Skyost/Bonsoir/issues
[PRs]: https://github.com/Skyost/Bonsoir/pulls
