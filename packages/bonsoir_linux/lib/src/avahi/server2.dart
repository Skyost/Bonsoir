...
class AvahiServer2StateChanged extends DBusSignal {
  ...
  AvahiServer2StateChanged(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class AvahiServer2 extends DBusRemoteObject {
  ...
  AvahiServer2(super.client, String destination, DBusObjectPath path) : super(name: destination, path: path) {
    stateChanged = DBusRemoteObjectSignalStream(object: this, interface: 'org.freedesktop.Avahi.Server2', name: 'StateChanged', signature: DBusSignature('is')).map(AvahiServer2StateChanged.new);
  }
  ...
  Future<List<DBusValue>> callResolveHostName(int interface, int protocol, String name, int aprotocol, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server2',
      'ResolveHostName',
  ...
  Future<List<DBusValue>> callResolveAddress(int interface, int protocol, String address, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server2',
      'ResolveAddress',
  ...
  Future<String> callEntryGroupNew({bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server2',
      'EntryGroupNew',
      [],
  ...
  Future<String> callDomainBrowserPrepare(int interface, int protocol, String domain, int btype, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server2',
  ...
  Future<String> callServiceTypeBrowserPrepare(int interface, int protocol, String domain, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server2',
  ...
  Future<String> callServiceBrowserPrepare(int interface, int protocol, String type, String domain, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server2',
  ...
  Future<String> callHostNameResolverPrepare(int interface, int protocol, String name, int aprotocol, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server2',
  ...
  Future<String> callAddressResolverPrepare(int interface, int protocol, String address, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server2',
  ...
  Future<String> callRecordBrowserPrepare(int interface, int protocol, String name, int clazz, int type, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server2',
