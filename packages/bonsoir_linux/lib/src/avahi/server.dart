...
class AvahiServerResolvedService extends DBusStruct {
  ...
  AvahiServerResolvedService(super.children) : values = children.toList();

  int get interface => (values[0] as DBusInt32).value;

  AvahiProtocol? get protocol => (values[1] as DBusInt32).value.toAvahiProtocol();
  ...
  AvahiProtocol? get aprotocol => (values[6] as DBusInt32).value.toAvahiProtocol();
...
class AvahiServerStateChanged extends DBusSignal {
  ...
  AvahiServerStateChanged(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class AvahiServer extends DBusRemoteObject {
  ...
  AvahiServer(super.client, String destination, DBusObjectPath path) : super(name: destination, path: path) {
    stateChanged = DBusRemoteObjectSignalStream(
      object: this,
      interface: 'org.freedesktop.Avahi.Server',
      name: 'StateChanged',
      signature: DBusSignature('is'),
    ).asBroadcastStream().map(AvahiServerStateChanged.new);
  }
  ...
  Future<List<DBusValue>> callResolveService({
    ...
    var result = await callMethod(
      'org.freedesktop.Avahi.Server',
      'ResolveService',
      [DBusInt32(interface), DBusInt32(protocol), DBusString(name), DBusString(type), DBusString(domain), DBusInt32(answerProtocol), DBusUint32(flags)],
  ...
  Future<String> callDomainBrowserNew(int interface, int protocol, String domain, int btype, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server',
      'DomainBrowserNew',
  ...
  Future<String> callServiceTypeBrowserNew(int interface, int protocol, String domain, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server',
  ...
  Future<String> callHostNameResolverNew({
    ...
    var result = await callMethod(
      'org.freedesktop.Avahi.Server',
      'HostNameResolverNew',
      [DBusInt32(interface), DBusInt32(protocol), DBusString(name), DBusInt32(answerProtocol), DBusUint32(flags)],
      replySignature: DBusSignature('o'),
      noAutoStart: noAutoStart,
      allowInteractiveAuthorization: allowInteractiveAuthorization,
    );
  ...
  Future<String> callAddressResolverNew(int interface, int protocol, String address, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server',
      'AddressResolverNew',
      [DBusInt32(interface), DBusInt32(protocol), DBusString(address), DBusUint32(flags)],
  ...
  Future<String> callRecordBrowserNew(int interface, int protocol, String name, int clazz, int type, int flags, {bool noAutoStart = false, bool allowInteractiveAuthorization = false}) async {
    var result = await callMethod(
      'org.freedesktop.Avahi.Server',
      'RecordBrowserNew',
