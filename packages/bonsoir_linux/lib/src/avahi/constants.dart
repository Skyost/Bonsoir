enum AvahiClientState { AVAHI_CLIENT_S_REGISTERING, AVAHI_CLIENT_S_RUNNING, AVAHI_CLIENT_S_COLLISION, AVAHI_CLIENT_FAILURE, AVAHI_CLIENT_CONNECTING }
...
extension AvahiProtocolHelpers on AvahiProtocol {
  static Map<AvahiProtocol, int> avahiProtocolToInt = AvahiIntHelpers.intToAvahiProtocol.map((key, value) => MapEntry(value, key));
...
extension AvahiIntHelpers on int {
  ...
  static Map<int, AvahiProtocol> intToAvahiProtocol = Map.from(AvahiProtocol.values.asMap())
    ..remove(2)
